...
static const char dmenufont[]       = "Source Code Pro:pixelsize=14:antialias=true:autohint=true";
static const char normbordercolor[] = "#3a3a3a";
static const char normbgcolor[]     = "#87d7d7";
static const char normfgcolor[]     = "#3a3a3a";
static const char selbordercolor[]  = "#d75f87";
static const char selbgcolor[]      = "#d75f87";
static const char selfgcolor[]      = "#e4e4e4";
static const char statbordercolor[] = "#ffafaf";
static const char statbgcolor[]     = "#ffafaf";
static const char statfgcolor[]     = "#3a3a3a";
...
static Key keys[] = {
	...
	{ WINDOZ,		XK_p,      spawn,	   {.v = poweroffcmd }},
	{ WINDOZ,		XK_r,      spawn,	   {.v = rebootcmd } },
	{ WINDOZ,		XK_s,      spawn,	   {.v = suspendcmd } },
	{ WINDOZ,		XK_l,      spawn,	   {.v = slockcmd } },
};
